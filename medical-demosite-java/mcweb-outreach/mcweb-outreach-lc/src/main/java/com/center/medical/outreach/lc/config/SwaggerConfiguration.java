...
package com.center.medical.outreach.lc.config;
...
public class SwaggerConfiguration {
    ...
    public Docket mainApiConfig() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(webApiInfo())
                // 创建选择器，控制哪些接口被加入文档
                .groupName("1.沃德健管云平台外联系统接口Main")
                .select()
                // 指定@ApiOperation标注的接口被加入文档
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                //这里指定Controller扫描包路径
                .apis(basePackage(
                        "com.center.medical.outreach.lc.controller"
                ))
    ...
    private ApiInfo webApiInfo() {
        return new ApiInfoBuilder()
                // 文档标题
                .title("沃德健管云平台外联系统接口api")
                // 文档描述
                .description("沃德健管云平台外联系统接口api文档Swagger版")
                // 版本
                .version("V1.0.0")
                // 版权
