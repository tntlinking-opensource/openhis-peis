 ...
 */
@Data
@TableName("SECTION_RESULT_MAIN")
@ApiModel(value = "SectionResultMain", description = "KS科室检查结果主表实体类")
public class OrSectionResultMain extends Model<OrSectionResultMain> implements Serializable {
    private static final long serialVersionUID = -79506868172612696L;
