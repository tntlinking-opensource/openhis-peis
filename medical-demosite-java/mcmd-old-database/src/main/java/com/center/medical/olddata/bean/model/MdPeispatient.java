...
@ApiModel(value = "MdPeispatient", description = "QT体检者表实体类")
public class MdPeispatient extends Model<MdPeispatient> implements Serializable {
    private static final long serialVersionUID = -98691260992572086L;
    ...
    @ApiModelProperty(value = "健康体检状态，详见：com.center.medical.bean.enums.jktjzt")
    private String jktjzt;

    /**
     * 职业体检状态，详见：
     * @see com.center.medical.bean.enums.jktjzt
     */
    @ApiModelProperty(value = "职业体检状态，详见：com.center.medical.bean.enums.jktjzt")
