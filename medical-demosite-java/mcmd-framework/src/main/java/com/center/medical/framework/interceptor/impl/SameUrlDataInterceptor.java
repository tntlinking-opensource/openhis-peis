package com.center.medical.framework.interceptor.impl;

import com.alibaba.fastjson.JSON;
import com.center.medical.common.annotation.RepeatSubmit;
import com.center.medical.common.constant.CacheConstants;
import com.center.medical.common.filter.RepeatedlyRequestWrapper;
import com.center.medical.common.utils.StringUtils;
import com.center.medical.common.utils.http.HttpHelper;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor {
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation) {
        ...
        RedisUtil.set(cacheRepeatKey, cacheMap, annotation.interval());
        return false;
    }
