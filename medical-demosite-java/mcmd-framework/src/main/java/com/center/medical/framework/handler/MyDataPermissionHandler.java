package com.center.medical.framework.handler;
    ...
    public Expression getSqlSegment(PlainSelect plainSelect, String whereSegment) {
        ...
        for (Method m : methods) {
            if (Objects.equals(m.getName(), methodName)) {
                BranchScope annotation = m.getAnnotation(BranchScope.class);
                if (annotation == null) {
                    return where;
                }
                log.info("分中心权限注解别名：{}", annotation.alias());
                ...
                usesEqualsTo.setLeftExpression(new Column(annotation.alias()));
                usesEqualsTo.setRightExpression(new StringValue(user.getCid()));
