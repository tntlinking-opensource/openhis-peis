...
@ApiModel(value = "MdBasconclusion", description = "总检结论词实体类")
public class MdBasconclusion extends Model<MdBasconclusion> implements Serializable {
    private static final long serialVersionUID = -74625485458224071L;
