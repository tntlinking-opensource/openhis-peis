...
/**
 * PACS-检查结果主表(MdPacsSectionResultMain)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdPacsSectionResultMain", description = "PACS-检查结果主表实体类")
public class MdPacsSectionResultMain extends Model<MdPacsSectionResultMain> implements Serializable {
    private static final long serialVersionUID = -68861310816750879L;
