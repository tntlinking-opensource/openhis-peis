...
/**
 * 销售目标自动统计(MdSalesTargetStatistic)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdSalesTargetStatistic", description = "销售目标自动统计实体类")
public class MdSalesTargetStatistic extends Model<MdSalesTargetStatistic> implements Serializable {
    private static final long serialVersionUID = 700192147338402903L;
