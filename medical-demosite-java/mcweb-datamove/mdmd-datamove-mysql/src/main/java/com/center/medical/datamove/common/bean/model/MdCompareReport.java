...
/**
 * 对比报告表，用于存储对报告都有哪些生成过(MdCompareReport)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdCompareReport", description = "对比报告表，用于存储对报告都有哪些生成过实体类")
public class MdCompareReport extends Model<MdCompareReport> implements Serializable {
    private static final long serialVersionUID = 586861228896204645L;
