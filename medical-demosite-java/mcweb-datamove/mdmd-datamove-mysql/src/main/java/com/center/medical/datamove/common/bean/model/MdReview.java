...
@Data
@TableName("md_review")
@ApiModel(value = "MdReview", description = "ZJ复查表实体类")
public class MdReview extends Model<MdReview> implements Serializable {
    private static final long serialVersionUID = 886388127816777701L;
