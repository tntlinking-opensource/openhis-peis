...
@Data
@TableName("md_wz_zys")
@ApiModel(value = "MdWzZys", description = "KS问诊——职业史实体类")
public class MdWzZys extends Model<MdWzZys> implements Serializable {
    private static final long serialVersionUID = -99844656428762026L;
