...
/**
 * 分中心部门表（对应原系统中的qx_cen_dept）(SysDepartment)表实体类
 *
 * @author ay
...
@ApiModel(value = "SysDepartment", description = "分中心部门表（对应原系统中的qx_cen_dept）实体类")
public class SysDepartment extends Model<SysDepartment> implements Serializable {
    private static final long serialVersionUID = -21002505555630913L;
