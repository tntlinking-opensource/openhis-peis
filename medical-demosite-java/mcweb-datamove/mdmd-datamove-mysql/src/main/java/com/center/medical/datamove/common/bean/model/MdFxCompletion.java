...
/**
 * 本次职业健康检查漏检人员及漏检项目人员一览表(MdFxCompletion)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdFxCompletion", description = "本次职业健康检查漏检人员及漏检项目人员一览表实体类")
public class MdFxCompletion extends Model<MdFxCompletion> implements Serializable {
    private static final long serialVersionUID = -29820348540841850L;
    ...
    @ApiModelProperty(value = "职业体检状态，详见：com.world.center.bean.enums.ExamStatus")
