...
@ApiModel(value = "MdWzZybs", description = "KS问诊——职业病史实体类")
public class MdWzZybs extends Model<MdWzZybs> implements Serializable {
    private static final long serialVersionUID = -59295333245500954L;
