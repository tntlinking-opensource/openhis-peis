...
public class PacsBasePartController extends BaseController {
     ...
     * @param pacsBasePart    查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R<IPage<PacsBasePart>> getPage(PageParamSimple pageParamSimple, PacsBasePart pacsBasePart) {
        PageParam<PacsBasePart> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.pacsBasePartService.getPage(page, pacsBasePart));
    }
    ...
    public R insert(@RequestBody PacsBasePart pacsBasePart) {
        return R.toResult(this.pacsBasePartService.save(pacsBasePart));
    }
    ...
    public R update(@RequestBody PacsBasePart pacsBasePart) {
        return R.toResult(this.pacsBasePartService.updateById(pacsBasePart));
    }
