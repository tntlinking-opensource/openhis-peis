...
public class WhysqzfwController extends BaseController {
    ...
    public R<IPage<Whysqzfw>> getPage(PageParamSimple pageParamSimple, Whysqzfw whysqzfw) {
        PageParam<Whysqzfw> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.whysqzfwService.getPage(page, whysqzfw));
    }
    ...
    public R insert(@RequestBody Whysqzfw whysqzfw) {
        return R.toResult(this.whysqzfwService.save(whysqzfw));
    }
    ...
    public R update(@RequestBody Whysqzfw whysqzfw) {
        return R.toResult(this.whysqzfwService.updateById(whysqzfw));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.whysqzfwService.removeByIds(ids));
    }
}
