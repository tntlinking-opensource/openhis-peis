...
@RequestMapping("sshy")
public class SshyController extends BaseController {
    /**
     * 服务对象
     */
    ...
    public R<IPage<Sshy>> getPage(PageParamSimple pageParamSimple, Sshy sshy) {
        PageParam<Sshy> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.sshyService.getPage(page, sshy));
    }
    ...
    public R<Sshy> selectOne(@PathVariable String id) {
        return R.ok(this.sshyService.getInfoById(id));
    }
    ...
    @ApiOperationSupport(ignoreParameters = {"sshy.id"})
    public R insert(@RequestBody Sshy sshy) {
        return R.toResult(this.sshyService.save(sshy));
    }
    ...
    public R update(@RequestBody Sshy sshy) {
        return R.toResult(this.sshyService.updateById(sshy));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.sshyService.removeByIds(ids));
    }
}
