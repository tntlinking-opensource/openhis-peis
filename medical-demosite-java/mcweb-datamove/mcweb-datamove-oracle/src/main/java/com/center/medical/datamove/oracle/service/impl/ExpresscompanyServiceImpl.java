...
import com.center.medical.datamove.oracle.dao.ExpresscompanyMapper;
...
public class ExpresscompanyServiceImpl extends ServiceImpl<ExpresscompanyMapper, Expresscompany> implements ExpresscompanyService {
     ...
     */
    @Override
    public IPage<Expresscompany> getPage(PageParam<Expresscompany> page, Expresscompany param) {
        return expresscompanyMapper.getPage(page, param);
    }
