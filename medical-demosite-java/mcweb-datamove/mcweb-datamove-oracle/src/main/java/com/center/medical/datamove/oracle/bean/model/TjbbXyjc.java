...
public class TjbbXyjc extends Model<TjbbXyjc> implements Serializable {
    private static final long serialVersionUID = -11828749085216686L;
    ...
    private String valueMinSsy;

    @ApiModelProperty(value = "收缩压高值")
    private String valueMaxSsy;

    @ApiModelProperty(value = "舒张压低值")
    private String valueMinSzy;

    @ApiModelProperty(value = "舒张压高值")
    private String valueMaxSzy;
