...
/**
 * JC职业病种分类(OccupationDiseastClass)接口
 *
 * @author ay
...
public class OccupationDiseastClassController extends BaseController {
     ...
     * @param occupationDiseastClass 查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询JC职业病种分类")
    public R<IPage<OccupationDiseastClass>> getPage(PageParamSimple pageParamSimple, OccupationDiseastClass occupationDiseastClass) {
        PageParam<OccupationDiseastClass> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.occupationDiseastClassService.getPage(page, occupationDiseastClass));
    }
    ...
    @ApiOperationSupport(ignoreParameters = {"occupationDiseastClass.id"})
    public R insert(@RequestBody OccupationDiseastClass occupationDiseastClass) {
        return R.toResult(this.occupationDiseastClassService.save(occupationDiseastClass));
    }
    ...
    public R update(@RequestBody OccupationDiseastClass occupationDiseastClass) {
        return R.toResult(this.occupationDiseastClassService.updateById(occupationDiseastClass));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.occupationDiseastClassService.removeByIds(ids));
    }
}
