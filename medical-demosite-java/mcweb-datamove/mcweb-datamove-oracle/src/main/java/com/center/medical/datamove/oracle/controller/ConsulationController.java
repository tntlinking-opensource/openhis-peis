...
public class ConsulationController extends BaseController {
     ...
     * @param consulation     查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R<IPage<Consulation>> getPage(PageParamSimple pageParamSimple, Consulation consulation) {
        PageParam<Consulation> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.consulationService.getPage(page, consulation));
    }
    ...
    public R insert(@RequestBody Consulation consulation) {
        return R.toResult(this.consulationService.save(consulation));
    }
    ...
    public R update(@RequestBody Consulation consulation) {
        return R.toResult(this.consulationService.updateById(consulation));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.consulationService.removeByIds(ids));
    }
}
