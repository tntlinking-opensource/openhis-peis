...
public class DrugstoreDrugController extends BaseController {
     ...
     * @param drugstoreDrug   查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R<IPage<DrugstoreDrug>> getPage(PageParamSimple pageParamSimple, DrugstoreDrug drugstoreDrug) {
        PageParam<DrugstoreDrug> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.drugstoreDrugService.getPage(page, drugstoreDrug));
    }
    ...
    @ApiOperationSupport(ignoreParameters = {"drugstoreDrug.id"})
    public R insert(@RequestBody DrugstoreDrug drugstoreDrug) {
        return R.toResult(this.drugstoreDrugService.save(drugstoreDrug));
    }
    ...
    public R update(@RequestBody DrugstoreDrug drugstoreDrug) {
        return R.toResult(this.drugstoreDrugService.updateById(drugstoreDrug));
    }
