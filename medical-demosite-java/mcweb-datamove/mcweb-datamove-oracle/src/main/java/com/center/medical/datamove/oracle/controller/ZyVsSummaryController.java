...
public class ZyVsSummaryController extends BaseController {
     ...
     * @param zyVsSummary     查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询JC职业病处理意见")
    public R<IPage<ZyVsSummary>> getPage(PageParamSimple pageParamSimple, ZyVsSummary zyVsSummary) {
    ...
    @ApiOperationSupport(ignoreParameters = {"zyVsSummary.id"})
    public R insert(@RequestBody ZyVsSummary zyVsSummary) {
        return R.toResult(this.zyVsSummaryService.save(zyVsSummary));
    }
    ...
    public R update(@RequestBody ZyVsSummary zyVsSummary) {
        return R.toResult(this.zyVsSummaryService.updateById(zyVsSummary));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.zyVsSummaryService.removeByIds(ids));
    }
}
