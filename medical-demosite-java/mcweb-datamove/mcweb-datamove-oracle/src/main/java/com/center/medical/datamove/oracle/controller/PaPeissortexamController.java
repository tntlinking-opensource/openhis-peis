...
public class PaPeissortexamController extends BaseController {
     ...
     * @param paPeissortexam  查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R<IPage<PaPeissortexam>> getPage(PageParamSimple pageParamSimple, PaPeissortexam paPeissortexam) {
        PageParam<PaPeissortexam> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.paPeissortexamService.getPage(page, paPeissortexam));
    }
    ...
    public R insert(@RequestBody PaPeissortexam paPeissortexam) {
        return R.toResult(this.paPeissortexamService.save(paPeissortexam));
    }
    ...
    public R update(@RequestBody PaPeissortexam paPeissortexam) {
        return R.toResult(this.paPeissortexamService.updateById(paPeissortexam));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.paPeissortexamService.removeByIds(ids));
    }
}
