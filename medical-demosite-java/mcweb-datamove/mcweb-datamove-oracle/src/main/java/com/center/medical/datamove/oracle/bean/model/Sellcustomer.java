...
public class Sellcustomer extends Model<Sellcustomer> implements Serializable {
    private static final long serialVersionUID = -96261420365257717L;
    ...
    @ApiModelProperty(value = "用工单位企业经济类型代码")
    ...
    @ApiModelProperty(value = "用人单位所属区全名称(企业)")
    private String unitarea;

    @ApiModelProperty(value = "用工单位所属区全名称")
