...
import com.center.medical.common.constant.ScheduleConstants;
import com.center.medical.common.exception.job.TaskException;
import com.center.medical.quartz.dao.SysJobMapper;
import com.center.medical.quartz.domain.SysJob;
import com.center.medical.quartz.service.ISysJobService;
import com.center.medical.quartz.util.CronUtils;
import com.center.medical.quartz.util.ScheduleUtils;
...
//            log.error("{}项目启动时，初始化字典到缓存", loadProperties.name);
        scheduler.clear();
