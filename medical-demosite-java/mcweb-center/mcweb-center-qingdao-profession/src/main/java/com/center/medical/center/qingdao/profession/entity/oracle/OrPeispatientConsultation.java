...
@Entity
@Table(name = "PEISPATIENT_CONSULTATION", schema = "MEDICAL", catalog = "")
public class OrPeispatientConsultation {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        OrPeispatientConsultation that = (OrPeispatientConsultation) o;
