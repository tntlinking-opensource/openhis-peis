...
public class Items extends Model<Items> implements Serializable {
    private static final long serialVersionUID = -48165701857829553L;
    ...
    @ApiModelProperty(value = "职业团检报告序号")
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "关联的检查项目列表")
    private List<InspectCharge> InspectChargeList;
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "md_basexamltem的Id")
    private String eId;

    @TableField(exist = false)
    @ApiModelProperty(value = "价格(登记专用)")
    private String jg;

    @TableField(exist = false)
    @ApiModelProperty(value = "销售打印分类名称")
    private String xsdyflName;
    ...
    @TableField(exist = false)
    @ApiModelProperty(value = "外送机构名称")
    private String wsjgName;

    @TableField(exist = false)
    @ApiModelProperty(value = "业务类型名称")
    private String bsCatName;
}
