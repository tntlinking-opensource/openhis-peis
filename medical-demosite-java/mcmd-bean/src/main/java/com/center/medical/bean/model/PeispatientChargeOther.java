...
/**
 * 体检者其他缴费(PeispatientChargeOther)表实体类
 *
 * @author 路飞船长
...
@ApiModel(value = "PeispatientChargeOther", description = "体检者其他缴费实体类")
public class PeispatientChargeOther extends Model<PeispatientChargeOther> implements Serializable {
    private static final long serialVersionUID = 660425147860583671L;
