...
/**
 * 批量复查通知人员(GroupReviewNoticePatient)表数据库访问层
 *
 * @author 路飞船长
...
public interface GroupReviewNoticePatientMapper extends BaseMapper<GroupReviewNoticePatient> {
     ...
     * @return 分页数据
     */
    IPage<GroupReviewNoticePatient> getList(PageParam<GroupReviewNoticePatient> page, @Param("param") GroupReviewNoticePatient param);
