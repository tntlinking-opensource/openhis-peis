...
import com.center.medical.dao.FollowUpMapper;
import com.center.medical.bean.model.FollowUp;
import com.center.medical.service.FollowUpService;
...
public class FollowUpServiceImpl extends ServiceImpl<FollowUpMapper, FollowUp> implements FollowUpService {
     ...
     */
    @Override
    public IPage<FollowUp> getList(PageParam<FollowUp> page, FollowUp param) {
        return followUpMapper.getList(page, param);
    }
