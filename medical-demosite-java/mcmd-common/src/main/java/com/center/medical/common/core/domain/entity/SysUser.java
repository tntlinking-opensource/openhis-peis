...
@Slf4j
@Data
@ApiModel(value = "用户信息", description = "用户信息表实体类")
public class SysUser extends BaseEntity {
    ...
    @Excel(name = "是否是医师", readConverterExp = "0=否,1=是")
    @ApiModelProperty(value = "是否是医师：0.否 1.是")
    private String isDoc;

    @Excel(name = "接口库用户代码（lis代码）")
    ...
    @ApiModelProperty(value = "上级名称（销售，只有一层）")
    private String superiorName;

    @Excel(name = "是否补检账号", readConverterExp = "0=否,1=是")
    @ApiModelProperty(value = "是否补检账号：0.否 1.是）")
    private Double isbj;
    ...
    @Excel(name = "入职日期", width = 30, dateFormat = "yyyy-MM-dd", type = Excel.Type.EXPORT)
     ...
     * 职业危害因素
     */
    @ApiModelProperty(value = "职业危害因素ID列表")
    private String[] harmClass;

    /**
     * 兼职分中心ID列表
     */
    @ApiModelProperty(value = "兼职分中心ID列表")
    private String[] useBranches;

    /**
     * 绑定科室ID列表
     */
    @ApiModelProperty(value = "绑定科室ID列表")
    ...
    public boolean isCenter() {
        //实现判断是否是分中心管理员\
//        log.info("是否是分中心管理员：{}", SecurityUtils.hasRole("center"));
        return SecurityUtils.hasRole("center");
    }
