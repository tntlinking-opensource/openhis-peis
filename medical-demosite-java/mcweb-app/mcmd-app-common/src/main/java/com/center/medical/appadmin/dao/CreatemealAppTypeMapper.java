...
/**
 * 小程序套餐类型(CreatemealAppType)数据库访问层
 *
 * @author ay
 * @since 2024-06-12 17:31:42
 */
public interface CreatemealAppTypeMapper extends BaseMapper<CreatemealAppType> {
     ...
     * @return 分页数据
     */
    IPage<CreatemealAppType> getPage(PageParam<CreatemealAppType> page, @Param("param") CMAppTypeParam param);
     ...
     * @return 详情信息
     */
    CreatemealAppType getInfoById(@Param("id") String id);
