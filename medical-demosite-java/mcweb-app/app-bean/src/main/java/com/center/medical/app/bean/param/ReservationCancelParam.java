...
public class ReservationCancelParam implements Serializable {
    ...
    public ReservationCancelParam(String reservationNo, Integer fUsecodehiden, String pcodeOrOrderId, String failReason, String systemId) {
        this.reservationNo = reservationNo;
        this.fUsecodehiden = fUsecodehiden;
        this.pcodeOrOrderId = pcodeOrOrderId;
        this.failReason = failReason;
        this.systemId = systemId;
    }

    public ReservationCancelParam() {
    }
}
