...
import com.center.medical.enterprise.common.bean.PdfToBase64Dto;
...
//                System.out.println("删除pdf");
            ...
            if (e instanceof FileNotFoundException) {
                ...
                throw new CommonBindException("报告文件不存在或者损坏，请联系客服！");
            } else {
                // 处理其他 IOException 异常
                throw new CommonBindException("获取报告文件失败，请重试！");
            }
        }
