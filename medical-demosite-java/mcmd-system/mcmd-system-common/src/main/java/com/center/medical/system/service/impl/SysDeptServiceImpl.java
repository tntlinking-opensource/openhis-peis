...
public class SysDeptServiceImpl implements ISysDeptService {
    ...
    public int insertDept(SysDept dept) {
        ...
        dept.setDeptNo(String.valueOf(snowflake.nextId()));
...
//    }
     ...
     */
    @Override
    public SysDept getByDeptNo(String deptNo) {
        return deptMapper.getByDeptNo(deptNo);
    }

    @Override
    public int updateDeptList(List<SysDept> list) {
     ...
     */
    @Override
    public List<DeptSimpleVo> getAllDepartment(SysDeptParam param) {
        return deptMapper.getAllDepartment(param);
    }
     ...
     */
    @Override
    public IPage<DeptSimpleVo> findAllDepartment(PageParam<DeptSimpleVo> page, SysDeptParam param) {
        //去除空格转成大写
        if (ObjectUtils.isNotEmpty(param.getInputCode())) {
            param.setInputCode(param.getInputCode().trim().toUpperCase());
        }
        IPage<DeptSimpleVo> page1 = deptMapper.findAllDepartment(page, param);
        return page1;
    }
     ...
     */
    @Override
    public List<SysDept> seletAllDept() {
        return deptMapper.seletAllDept();
    }
     ...
     */
    @Override
    public List<DeptSimpleVo> getKs(String srm) {
        if (ObjectUtils.isNotEmpty(srm)) {
            srm = srm.trim();
        }
        return deptMapper.getKs(srm);
    }
     ...
     */
    @Override
    public List<DeptSimpleVo> getKsBySrm(String srm) {
        String username = SecurityUtils.getUsername();
        //去空格
        if (ObjectUtils.isNotEmpty(srm)) {
            srm = srm.trim();
        }
        return deptMapper.getKsBySrm(srm, username);
    }
     ...
     */
    @Override
    public List<AllKsVo> getAllks(String key) {
        return deptMapper.getAllks(key);
    }
     ...
     */
    @Override
    public List<AllDepartDataVo> getAllDepartData(String key) {
        if (ObjectUtils.isNotEmpty(key)) {
            key = key.trim();
        }
        return deptMapper.getAllDepartData(key);
    }
     ...
     */
    @Override
    public String getDepSrm(String depName) {
        return deptMapper.getDepSrm(depName);
    }
}
