...
public interface MonthtargetMapper extends BaseMapper<Monthtarget> {
     ...
     * @return 分页数据
     */
    IPage<MonthtargetVo> getList(PageParam<MonthtargetVo> page, @Param("param") MonthtargetParam param);
     ...
     * @return
     */
    List<MTSummaryVo> getSummaryData(@Param("param")MonthtargetParam param);
     ...
     * @return
     */
    List<MonthtargetVo> getExportData(@Param("param")MonthtargetParam param);
}
