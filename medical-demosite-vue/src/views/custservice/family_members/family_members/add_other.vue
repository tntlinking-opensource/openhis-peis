<!-- 家庭会员-家庭卡办理-其他家庭成员信息 麦沃德科技 开发人:暴雨 -->
<template>
    <!-- <div class="add-container"> -->
        <el-dialog title="新增其他家庭成员信息" :visible.sync="open" width="856px" :close-on-click-modal="false" append-to-body>
            <el-form size="small" :inline="true" label-width="80px" :model="form" :rules="rules" >
                ...
                <el-form-item label="生日" style="margin-right:0;">
                    <el-date-picker style="width:308px; height: 40px;" :clearable='false'  type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择日期"  v-model="form.birthdate" ></el-date-picker>
                </el-form-item>
                <el-form-item label="分中心" style="margin-right:32px;">
                    <el-select style="width:308px; height: 40px;" placeholder="请选择"  v-model="form.fzx">
                      <el-option v-for="item in idExamsuite" :key="item.fzx" :value="item.fzx" :label="item.fzx"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="创建日期" style="margin-right:0;">
                  <el-date-picker style="width:308px; height: 40px;" :clearable='false' placeholder="请选择日期"  v-model="form.createDate"  type="datetime" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-form-item>
    ...
    export default{
        ...
        methods:{
            ...
            onOk(){
                ...
                this.$emit("closedialogs",this.form)
                this.onCancel()
            },
            onCancel(){
                this.open = false;
