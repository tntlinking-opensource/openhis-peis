<!-- 查看不满意客户深访  开发人：麦沃德科技矢北 -->
<template>
  <el-dialog title="查看非常满意客户" :visible.sync="open" class="add-items" width="1400px" style="height:600px ;" :close-on-click-modal="false"
    append-to-body>
    <el-form v-loading="popLoading" ref="form" :model="form" :inline="true" label-width="70px" hide-required-asterisk>
    ...
    <div class="table-box">
      <el-table border v-loading="loading" :data="tableList" height="80%" stripe>
...
<script>
import { getSatisfactionList } from "@/api/custservice/satisfaction/dissatisfied.js";
export default {
  data() {
    return {
      total:0,
  ...
  methods: {
    ...
    handleQuery() {
      ...
      if (this.form.date) {
        ...
        this.form.startRegTime = undefined
        this.form.endRegTime = undefined
      }
