<template>
  <div class="app-container flex-direction-column">
    ...
    <div class="table-box">
      <el-table v-if="refreshTable" v-loading="loading" :data="menuList" height="100%" row-key="menuId" border :default-expand-all="isExpandAll" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
        ...
        <el-table-column prop="status" label="隐藏" width="80">
          <template slot-scope="scope">
            {{['','已隐藏'][scope.row.visible]}}
          </template>
        </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="110px" v-loading="editLoading">
        <el-row>
          <el-col :span="24">
