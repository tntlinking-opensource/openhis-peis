<!-- 职业健康检查职业禁忌证人员名单	 开发人：麦沃德科技矢北 / 暴雨-->
<template>
  <div class="app-container flex-direction-column">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-upload2" @click="handleLook" v-hasPermi="['statistical:professioncChecks:forbiddenList:view']">导出</el-button>
      </el-col>
    </el-row>
    <div class="table-box">
      <el-table border v-loading="loading" :data="tableList" height="100%" stripe>
        ...
        <el-table-column label="单位名称" prop="orgName" align="center" width="130" show-overflow-tooltip />
        ...
        <el-table-column label="接害因素" prop="jhys" align="center" show-overflow-tooltip />
        <el-table-column label="禁忌症" prop="disease" align="center" show-overflow-tooltip />
  ...
  methods: {
    ...
    getBranch() {
      getBranchData().then((response) => {
        ...
        if (!this.queryParams.cid) this.queryParams.cid = this.$getCookie('cid')
      })
    },
    //团检单位
    ...
    resetQuery() {
      ...
      this.queryParams.cid = this.$getCookie('cid')
