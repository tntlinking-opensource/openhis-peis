...
<template>
  <div class="app-container flex-direction-column">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-upload2" @click="handleExport" v-hasPermi="['statistical:chargeDistribute:export']">导出Excel</el-button>
      </el-col>
    </el-row>
    <!-- 表格 -->
    <div class="table-box">
      <el-table border v-loading="loading" :data="tableList" height="100%" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column label="科室" prop="charge0" align="center" min-width="200" />
        <el-table-column label="收费项目" prop="charge1" align="center" min-width="200" />
        <el-table-column label="体检者数量" prop="charge2" align="center" />
        <el-table-column label="实收金额" prop="charge3" align="center" />
        <el-table-column label="应收金额" prop="charge4" align="center" />
        <el-table-column label="成本合计" prop="charge5" align="center" />
        <el-table-column label="折扣率" prop="charge6" align="center" />
        <el-table-column label="个检数量" prop="charge7" align="center" />
        <el-table-column label="团体自费数量" prop="charge8" align="center" />
        <el-table-column label="团体统收数量" prop="charge9" align="center" />
      </el-table>
    </div>
    <!-- 分页 -->
...
<script>
import { getListdata } from '@/api/statistical/charge_distribute'
export default {
  components: {},
  props: [],
  data() {
  ...
  methods: {
    ...
    handleExport() {
      this.queryParams.startTime = this.queryParams.startTime ? this.queryParams.startTime.slice(0, 10) + ' 00:00:00' : undefined
      this.queryParams.endTime = this.queryParams.endTime ? this.queryParams.endTime.slice(0, 10) + ' 23:59:59' : undefined
      this.download('/statistics/chargeDistribute/export', this.queryParams, `收费项目分布情况.xlsx`)
    },
    // 多选框选中数据
