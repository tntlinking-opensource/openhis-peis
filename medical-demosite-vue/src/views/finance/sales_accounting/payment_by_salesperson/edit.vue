    ...
    <el-dialog :title="title" :visible.sync="open" width="860px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" :inline="true" label-width="110px" style="margin-top: 20px" hide-required-asterisk v-loading="popLoading">
        <el-form-item label="1月(元):" prop="yy">
          <el-input v-model="form.yy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="2月(元):" prop="ey">
          <el-input v-model="form.ey" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="3月(元):" prop="sy">
          <el-input v-model="form.sy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="4月(元):" prop="iy">
          <el-input v-model="form.iy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="5月(元):" prop="wy">
          <el-input v-model="form.wy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="6月(元):" prop="ly">
          <el-input v-model="form.ly" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="7月(元):" prop="qy">
          <el-input v-model="form.qy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="8月(元):" prop="ay">
          <el-input v-model="form.ay" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="9月(元):" prop="jy">
          <el-input v-model="form.jy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="10月(元):" prop="oy">
          <el-input v-model="form.oy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="11月(元):" prop="ny">
          <el-input v-model="form.ny" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        <el-form-item label="12月(元):" prop="dy">
          <el-input v-model="form.dy" placeholder="暂无数据" clearable style="width: 260px" />
        </el-form-item>
        ...
        <el-form-item label="备注:" prop="bz">
          <el-input v-model="form.bz" placeholder="暂无数据" clearable style="width: 640px" />
        </el-form-item>
      </el-form>
