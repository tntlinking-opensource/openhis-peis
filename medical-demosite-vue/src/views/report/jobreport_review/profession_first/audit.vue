...
<script>
import { getListData, professionFirstPass } from "@/api/report/jobreport_review/profession_first";
export default {
	components: {},
	props: [],
	data() {
	...
	methods: {
		...
		submitForm() {
			...
			professionFirstPass(this.tableList.map((item) => item.id)).then(response => {
