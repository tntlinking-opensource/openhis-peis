...
<script>
import { professionFirstUncheck } from "@/api/report/jobreport_review/profession_first.js";
export default {
	components: {},
	props: [],
	data() {
	...
	methods: {
		...
		// 提交按钮
		submitForm() {
			professionFirstUncheck(this.form.id, this.form.lastReason || "无").then(response => {
