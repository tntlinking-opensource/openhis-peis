...
<script>
import { professionSecondUncheck } from "@/api/report/jobreport_review/profession_second";
export default {
	components: {},
	props: [],
	data() {
	...
	methods: {
		...
		// 提交按钮
		submitForm() {
			professionSecondUncheck(this.form.id, this.form.lastReason || "无").then(response => {
