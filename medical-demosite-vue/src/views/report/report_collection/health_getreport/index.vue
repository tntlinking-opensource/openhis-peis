  ...
  <div class="app-container flex-direction-column">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" class="no-margin-bottom">
      ...
      <el-form-item label="开单医师" prop="idOpendoctor">
        <input-select :selectData="doctorData" @change="opendoctorChange"></input-select>
      </el-form-item>
      ...
      <el-form-item label="柜子号" prop="chestNum">
        <el-input v-model="queryParams.chestNum" placeholder="请输入柜子号" clearable style="width: 160px" @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="排序方式" prop="sort">
        <el-select v-model="queryParams.sort" placeholder="请选择排序方式" clearable style="width: 160px">
          <el-option label="交接时间" value="revTime" />
          <el-option label="体检时间" value="dateregister" />
        </el-select>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-plus" @click="handleReceive" v-hasPermi="['report:reportCollection:healthGetreport:receive']">领取 </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain size="mini" icon="el-icon-circle-close" @click="handleUnReceive" v-hasPermi="['report:reportCollection:healthGetreport:unReceive']">反领取 </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-upload2" @click="handleExport" v-hasPermi="['report:reportCollection:healthGetreport:export']">导出Excel </el-button>
      </el-col>
    </el-row>
    <!-- 表格 -->
    <div class="table-box">
      <el-table ref="tableList" border v-loading="loading" :data="tableList" height="100%" stripe @selection-change="handleSelectionChange" @row-click="rowClick">
        ...
        <el-table-column label="性别" prop="sex" min-width="90px" align="center" show-overflow-tooltip>
        ...
        <el-table-column label="年龄" prop="age" min-width="90px" align="center" show-overflow-tooltip />
        <el-table-column label="报告状态" prop="status" min-width="130px" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
...
import { getBoxData, getListData, getUnnotice } from '@/api/report/report_collection/health_getreport'
...
export default {
  ...
  methods: {
    ...
    //发放人选项
    issueIdChange(value) {
      this.queryParams.issueId = value.id
      this.issueIdData.bindValue = value.username
    },
    // 开单医师选项
    opendoctorChange(value) {
...
<style scoped>
.sign-dialog /deep/ .el-dialog .el-dialog__body {
  width: 550px;
}
</style>
