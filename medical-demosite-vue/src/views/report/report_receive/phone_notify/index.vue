  ...
  <div class="app-container flex-direction-column">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="通知结果" prop="notificationResult">
        <el-select v-model="queryParams.notificationResult" placeholder="请选择通知结果" clearable style="width: 150px;">
      ...
      <el-form-item label="交接日期" prop="date">
        <el-date-picker v-model="queryParams.date" style="width: 290px;" value-format="yyyy-MM-dd" type="daterange"
          range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
      </el-form-item>
      <el-form-item label="柜子号" prop="chestNum">
        <el-input v-model="queryParams.chestNum" placeholder="请输入柜子号" clearable style="width: 150px" />
      </el-form-item>
      <el-form-item label="通知状态" prop="noticeStatus">
        <el-select v-model="queryParams.noticeStatus" placeholder="请选择通知状态" clearable style="width: 150px;">
          <el-option label="未通知" :value="0" />
          <el-option label="已通知" :value="1" />
        </el-select>
      </el-form-item>
      <el-form-item label="年龄" prop="startAge">
        <el-input-number v-model="queryParams.startAge" controls-position="right" :min="1" :max="100"></el-input-number>
      </el-form-item>
      <el-form-item label="-" prop="endAge">
        <el-input-number v-model="queryParams.endAge" controls-position="right" :min="1" :max="100"></el-input-number>
      </el-form-item>
      <el-form-item label="检查结论" prop="occupationSummary">
        <input-select ref="occSummary" :selectData="selectData1" @change="selectChange2"></input-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-plus" @click="handleqNotice(1)" :disabled="multiple"
          v-hasPermi="['report:reportReceive:healthNotify:notice']">电话通知
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain size="mini" icon="el-icon-coin" @click="handleSendMsg"
          v-hasPermi="['report:reportReceive:healthNotify:sendMsg']">短信通知
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain size="mini" icon="el-icon-circle-close" @click="handleqNotice(2)"
          :disabled="multiple" v-hasPermi="['report:reportReceive:healthNotify:noticeerror']">号码错误
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button plain size="mini" icon="el-icon-download" @click="handleqNotice(3)" :disabled="multiple"
          v-hasPermi="['report:reportReceive:healthNotify:nonotice']">未接通
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain size="mini" icon="el-icon-circle-close" @click="handleCancelSMS"
          :disabled="multiple" v-hasPermi="['report:reportReceive:healthNotify:cancelsms']">取消发送
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-search" @click="handleViewsms" :disabled="single"
          v-hasPermi="['report:reportReceive:healthNotify:viewsms']">查看短信
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="primary" plain size="mini" icon="el-icon-upload2" @click="handleExport"
          v-hasPermi="['report:reportReceive:healthNotify:export']">导出Excel
        </el-button>
      </el-col>
    ...
    <!-- 表格 -->
    <div class="table-box">
      <el-table border ref="selectTable" v-loading="loading" :data="tableList" height="100%" stripe
        ...
        <el-table-column label="开单医师" prop="doctorapply" min-width="100px" align="center"
        ...
        <el-table-column label="发放方式" prop="methodName" min-width="100px" align="center"
          show-overflow-tooltip />
        <el-table-column label="登记时间" prop="dateregister" min-width="160px" align="center"
          show-overflow-tooltip />
        <el-table-column label="通知时间" prop="notifyDate" min-width="160px" align="center"
          show-overflow-tooltip />
...
import { getListData, cancelSMS } from '@/api/report/report_receive/phone_notify.js'
export default {
  name: "Phone_notify",
  ...
  data() {
    return {
      ...
      selectData: {
        ...
        key: '输入码',//第一列标题
        value: '体检单位',//第二列标题
        url: '/sell/official/customer/getAllOrg',//请求连接
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/report/phoneInform/export', {
        ...this.queryParams
      }, `职业报告领取通知.xlsx`)
    },
  },
