<!-- 职业报告交接-交接 麦沃德科技 开发人:清风/暴雨 -->
<template>
  <el-dialog :title="title" class="add-items" :visible.sync="open" width="1500px" append-to-body :close-on-click-modal="false" @close="closeDialog">
    <div class="add-container flex-direction-column">
      <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
        ...
        <el-form-item label="承接人密码" label-width="90px">
          <el-input placeholder="请输入承接人密码" clearable style="width: 160px" v-model="queryParams.password"></el-input>
        </el-form-item>
        <el-form-item label="交接/反交接日期">
      ...
      <div class="table-box" style="min-height: 650px">
        <el-table border v-loading="loading" :data="tableData" height="670px" style="width: 100%" stripe @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="zytjzt" label="审核状态" min-width="140px" align="center" fixed>
            <template slot-scope="scope">
              <span :style="'color: ' + auditColor(scope.row.zytjzt)">
                {{ auditStatus(scope.row.zytjzt) }}
              </span>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="chestNum" label="柜子号" min-width="120px" align="center"></el-table-column>
...
<script>
import { getBoxData, getListData, getLoginName, getPatientData, saveOrUpdate, unaudit } from '@/api/report/health_handover/profession_handover'
export default {
  data() {
    return {
      showSearch: true,
