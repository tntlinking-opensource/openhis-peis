...
<script>
import { healthFirstUncheck } from "@/api/report/report_review/health_first";
export default {
	components: {},
	props: [],
	data() {
	...
	methods: {
		...
		// 提交按钮
		submitForm() {
			healthFirstUncheck(this.form.id, this.form.lastReason || "无").then(response => {
