  ...
  <div class="app-container flex-direction-column">
    ...
    <div class="table-box">
      <el-table ref="tableDate" border v-loading="loading" :data="tableDate" height="100%" @selection-change="handleSelectionChange" @row-click="rowClick">
        ...
        <el-table-column label="分中心" align="center" prop="branchName" show-overflow-tooltip />
        <el-table-column label="商户编号" align="center" prop="mno" show-overflow-tooltip />
        <el-table-column label="机构编号" align="center" prop="orgId" show-overflow-tooltip />
    ...
    <el-dialog :title="title" :visible.sync="open" width="1060px" class="sub-center report-setting" destroy-on-close append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" :inline="true" hide-required-asterisk v-loading="loading"
        ...
        <el-form-item label="商户编号" prop="mno">
          <el-input v-model="form.mno" placeholder="请输入商户编号" clearable style="width: 340px" />
        </el-form-item>
        <el-form-item label="机构编号" prop="orgId">
          <el-input v-model="form.orgId" placeholder="请输入机构编号" clearable style="width: 340px" />
        </el-form-item>
        <el-form-item label="私钥" prop="privateKey">
          <el-input type="textarea" :rows="4" v-model="form.privateKey" placeholder="请输入私钥" clearable style="width: 810px" />
        </el-form-item>
      </el-form>
...
<script>
import { getListApi, saOrUp, getDetailsApi, deleteApi } from '@/api/applet/suiXing.js'
