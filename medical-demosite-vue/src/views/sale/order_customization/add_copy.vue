        ...
        <el-form ref="form" size="small" :model="form" :rules="formRules" :inline="true" label-width="140px" hide-required-asterisk :style="isCheck ? 'pointer-events:none;' : ''">
          ...
          <template v-if="!isCheck">
            ...
            <el-form-item label="复查收费方式" prop="reviewPayway">
              <el-select v-model="form.reviewPayway" placeholder="请选择" style="width: 280px">
                <el-option label="现金" value="1" />
                <el-option label="统收" value="5" />
                <el-option label="其他" value="1679299202779451392" />
              </el-select>
            </el-form-item>
    ...
    <div class="add-table">
      ...
      <el-row>
        ...
        <el-col :span="12" style="height: 700px">
          <el-table border ref="tableData" :data="tableList1" height="100%" stripe v-loading="leftLoading" @selection-change="handleSelectionChange1" @row-click="rowClick" @row-dblclick="rowDblclick" :row-class-name="forbid2Red">
            ...
            <el-table-column label="体检套餐名称" prop="tjtcmc" min-width="240" align="center">
              <template slot-scope="scope">
                <input-select :selectData="selectData2" @change="selectChange2($event, scope.row)" :selectSize="'mini'" :initialValue="scope.row.tjtcmc" v-if="!isCheck && scope.row.spzt != 1"></input-select>
  ...
  data() {
    ...
    return {
      ...
      formRules: {
        ...
        reviewPayway: [{ required: true, message: '复查收费方式不能为空', trigger: 'change' }],
      },
      // 检期内已有订单弹窗
      openOrder: false,
      // 已有订单列表
  ...
  methods: {
    ...
    initForm() {
      ...
      this.form = {
        ...
        tjlx: 0,
        chestNum: undefined,
        reviewPayway: '1679299202779451392',
        reviewZk: 10.0,
