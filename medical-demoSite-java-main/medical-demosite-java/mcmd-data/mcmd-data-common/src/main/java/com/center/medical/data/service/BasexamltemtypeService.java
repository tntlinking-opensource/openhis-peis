...
/**
 * JC检查项目类型表(Basexamltemtype)表服务接口
 *
 * @author 路飞船长
...
public interface BasexamltemtypeService extends IService<Basexamltemtype> {
     ...
     * @return 分页数据
     */
    IPage<Basexamltemtype> getPage(PageParam<Basexamltemtype> page, ExamItemTypePrama param);
     ...
     * @return 列表数据
     */
    List<Basexamltemtype> getList(ExamItemTypePrama param);
     ...
     * @return
     */
    Boolean saOrUp(Basexamltemtype basexamltemtype);
