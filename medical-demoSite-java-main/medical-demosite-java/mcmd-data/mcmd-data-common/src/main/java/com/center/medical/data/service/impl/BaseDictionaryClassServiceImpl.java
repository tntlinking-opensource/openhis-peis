...
import com.center.medical.data.dao.BaseDictionaryClassMapper;
...
/**
 * 字典类型(BaseDictionaryClass)表服务实现类
 *
 * @author ay
...
public class BaseDictionaryClassServiceImpl extends ServiceImpl<BaseDictionaryClassMapper, BaseDictionaryClass> implements BaseDictionaryClassService {
    ...
    */
    @Override
    public IPage<BaseDictionaryClass> getList(PageParam<BaseDictionaryClass> page, BaseDictionaryClass param) {
        return baseDictionaryClassMapper .getList(page, param);
    }
