...
public class SysJobController extends BaseController {
    ...
    @GetMapping("/list")
    @ApiOperation(value = "列表", notes = "查询定时任务列表")
    ...
    @Log(title = "定时任务-导出定时任务列表", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @ApiOperation(value = "导出", notes = "导出定时任务列表")
    ...
    @ApiOperation(value = "详细信息", notes = "获取定时任务详细信息")
    ...
    @Log(title = "定时任务-定时任务状态修改", businessType = BusinessType.UPDATE)
    @PutMapping("/changeStatus")
    @ApiOperation(value = "状态修改", notes = "定时任务状态修改")
    ...
    @PutMapping("/run")
    @ApiOperation(value = "立即执行一次", notes = "定时任务立即执行一次")
    ...
    @ApiOperation(value = "删除", notes = "删除定时任务")
