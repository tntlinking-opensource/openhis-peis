...
@Api(tags = "团体预约记录")
@RequestMapping("reservationGroup")
public class ReservationGroupController extends BaseController {
    ...
    public R insert(@RequestBody ReservationGroup reservationGroup) {
        return R.toResult(this.reservationGroupService.save(reservationGroup));
    }
    ...
    public R update(@RequestBody ReservationGroup reservationGroup) {
        return R.toResult(this.reservationGroupService.updateById(reservationGroup));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.reservationGroupService.removeByIds(ids));
    }
}
