...
/**
 * 体检者任务分组(Peisorgreservationgroup)表实体类
 *
 * @author 路飞船长
...
@ApiModel(value = "Peisorgreservationgroup", description = "体检者任务分组实体类")
public class Peisorgreservationgroup extends Model<Peisorgreservationgroup> implements Serializable {
    private static final long serialVersionUID = -55264198986903763L;
