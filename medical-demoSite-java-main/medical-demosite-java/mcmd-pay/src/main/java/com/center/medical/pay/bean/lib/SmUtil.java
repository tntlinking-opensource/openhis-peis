...
public class SmUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean isOk = verifySM3SM2(publicKey, "Allinpay", Base64.getDecoder().decode(rspSign), rspBlankStr.getBytes("UTF-8"));
    ...
    public static String signSM3SM2RetBase64(final PrivateKey privateKey, String certid, final byte[] data) throws Exception {
        return Base64.getEncoder().encodeToString(signSM3SM2(privateKey, certid, data));
    }
