...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                //这里指定Controller扫描包路径
                .apis(basePackage(
                        "com.center.medical.admin.controller"
                ))
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
    ...
    public Docket reservationApiConfig() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //这里指定Controller扫描包路径
                .apis(basePackage(
                        "com.center.medical.reservation.controller"
                ))
                .paths(PathSelectors.any())
                .build();
    }
    ...
    @Bean("SyncLcApiConfig")
    public Docket syncLcApiConfig() {
        return new Docket(DocumentationType.SWAGGER_2)
                // 创建接口文档的具体信息
                .apiInfo(webApiInfo())
                .groupName("11.数据同步系统")
                ...
                //这里指定Controller扫描包路径
                .apis(basePackage(
                        "com.center.medical.synclc.controller"
                ))
                .paths(PathSelectors.any())
                .build();
    }
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
    ...
    public Docket messageApiConfig() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //这里指定Controller扫描包路径
                .apis(basePackage(
                        "com.center.medical.messagelc.controller" + splitor + "com.center.medical.messagelc.open"
                ))
                .paths(PathSelectors.any())
                .build();
    }
