...
/**
 * PACS-体检者收费项目表(PacsPeispatientfeeitem)表实体类
 *
 * @author 路飞船长
...
@ApiModel(value = "PacsPeispatientfeeitem", description = "PACS-体检者收费项目表实体类")
public class PacsPeispatientfeeitem extends Model<PacsPeispatientfeeitem> implements Serializable {
    private static final long serialVersionUID = -34279088702777716L;
