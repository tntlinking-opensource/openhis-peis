 ...
 */
public interface ApprovalStatusService extends IService<Peispatient> {
     ...
     * @return 分页数据
     */
    IPage<ApprovalStatusVo> getPage(PageParam<ApprovalStatusVo> page, ApprovalStatusParam param);
