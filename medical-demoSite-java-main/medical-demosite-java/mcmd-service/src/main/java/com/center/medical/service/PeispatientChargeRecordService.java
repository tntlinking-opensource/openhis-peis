...
/**
 * 收费记录(PeispatientChargeRecord)表服务接口
 *
 * @author 路飞船长
...
public interface PeispatientChargeRecordService extends IService<PeispatientChargeRecord> {
     ...
     * @return 分页数据
     */
    IPage<PeispatientChargeRecord> getList(PageParam<PeispatientChargeRecord> page, PeispatientChargeRecord param);
     ...
     * @param id id主键
     */
    PeispatientChargeRecord getInfoById(String id);
