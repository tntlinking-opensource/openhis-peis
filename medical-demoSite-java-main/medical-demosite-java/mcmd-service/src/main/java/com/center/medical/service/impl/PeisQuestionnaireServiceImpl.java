...
import com.center.medical.dao.PeisQuestionnaireMapper;
import com.center.medical.bean.model.PeisQuestionnaire;
import com.center.medical.service.PeisQuestionnaireService;
...
/**
 * 体检者沃德国际健康问卷(PeisQuestionnaire)表服务实现类
 *
 * @author 路飞船长
...
public class PeisQuestionnaireServiceImpl extends ServiceImpl<PeisQuestionnaireMapper, PeisQuestionnaire> implements PeisQuestionnaireService {
     ...
     */
    @Override
    public IPage<PeisQuestionnaire> getList(PageParam<PeisQuestionnaire> page, PeisQuestionnaire param) {
        return peisQuestionnaireMapper.getList(page, param);
    }
