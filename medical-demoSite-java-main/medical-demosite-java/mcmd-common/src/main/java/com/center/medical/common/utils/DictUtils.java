...
//        log.warn("设置字典缓存：{}、{}", getCacheKey(key), dictDatas);
        RedisUtil.set(getCacheKey(key), dictDatas, 0);
    }
    ...
    public static List<SysDictData> getDictCache(String key) {
        List<SysDictData> arrayCache = RedisUtil.get(getCacheKey(key));
...
//        }
    ...
    public static void clearDictCache() {
        Collection<String> keys = RedisUtil.keys(CacheConstants.SYS_DICT_KEY + "*");
