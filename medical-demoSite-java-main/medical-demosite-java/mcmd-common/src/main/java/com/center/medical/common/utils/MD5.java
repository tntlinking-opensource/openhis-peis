...
public class MD5 {
	...
	public static void main(String[] args) {
		log.info("===========MD5启动了================");
		System.out.println("admin:" + encode("admin").toUpperCase());
		MessageDigestPasswordEncoder encoder = new MessageDigestPasswordEncoder("SHA-256");
//        System.out.println(encoder.encodePassword("123", "month"));
//        System.out.println(encoder.encodePassword("123", "admin"));
