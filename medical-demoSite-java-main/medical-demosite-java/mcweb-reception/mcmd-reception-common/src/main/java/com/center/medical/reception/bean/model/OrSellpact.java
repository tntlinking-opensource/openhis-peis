 ...
 *
 * @author ay
 * @since 2023-07-25 21:19:13
 */
@Data
@TableName("SELLPACT")
@ApiModel(value = "Sellpact", description = "销售合同维护表实体类")
public class OrSellpact extends Model<OrSellpact> implements Serializable {
    private static final long serialVersionUID = 408143353407863140L;
