 ...
 *
 * @author ay
 * @since 2023-07-25 21:56:06
 */
@Data
@TableName("CREATEMEAL")
@ApiModel(value = "Createmeal", description = "普通套餐表实体类")
public class OrCreatemeal extends Model<OrCreatemeal> implements Serializable {
    private static final long serialVersionUID = -27095947435960252L;
