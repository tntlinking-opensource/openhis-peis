...
/**
 * 健康体检问卷(MdPeisQuestionnaireSecond)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdPeisQuestionnaireSecond", description = "健康体检问卷实体类")
public class MdPeisQuestionnaireSecond extends Model<MdPeisQuestionnaireSecond> implements Serializable {
    private static final long serialVersionUID = 752367679136793580L;
