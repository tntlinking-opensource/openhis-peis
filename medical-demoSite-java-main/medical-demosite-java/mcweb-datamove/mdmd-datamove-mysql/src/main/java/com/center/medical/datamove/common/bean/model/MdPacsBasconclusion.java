...
/**
 * pacs总检结论词(MdPacsBasconclusion)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdPacsBasconclusion", description = "pacs总检结论词实体类")
public class MdPacsBasconclusion extends Model<MdPacsBasconclusion> implements Serializable {
    private static final long serialVersionUID = 155660975190241499L;
