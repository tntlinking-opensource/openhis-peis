...
@ApiModel(value = "MdTbPatient", description = "同步主表实体类")
public class MdTbPatient extends Model<MdTbPatient> implements Serializable {
    private static final long serialVersionUID = 638195590519625449L;
