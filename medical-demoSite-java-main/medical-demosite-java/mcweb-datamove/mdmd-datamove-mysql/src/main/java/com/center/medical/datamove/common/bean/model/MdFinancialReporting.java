...
/**
 * 财务提报(MdFinancialReporting)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdFinancialReporting", description = "财务提报实体类")
public class MdFinancialReporting extends Model<MdFinancialReporting> implements Serializable {
    private static final long serialVersionUID = 977590569017355724L;
