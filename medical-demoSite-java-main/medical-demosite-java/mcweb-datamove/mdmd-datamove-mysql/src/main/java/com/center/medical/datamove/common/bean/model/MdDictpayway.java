...
@ApiModel(value = "MdDictpayway", description = "JC支付方式表实体类")
public class MdDictpayway extends Model<MdDictpayway> implements Serializable {
    private static final long serialVersionUID = 652739522135044767L;
