...
/**
 * 发票(MdPeisorgreservationreceipt)表实体类
 *
 * @author ay
...
@ApiModel(value = "MdPeisorgreservationreceipt", description = "发票实体类")
public class MdPeisorgreservationreceipt extends Model<MdPeisorgreservationreceipt> implements Serializable {
    private static final long serialVersionUID = -96669669939626142L;
