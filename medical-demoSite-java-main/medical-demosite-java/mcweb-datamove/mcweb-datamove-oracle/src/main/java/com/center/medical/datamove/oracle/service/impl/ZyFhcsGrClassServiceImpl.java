...
import com.center.medical.datamove.oracle.dao.ZyFhcsGrClassMapper;
...
/**
 * JC个人防护用品种类(ZyFhcsGrClass)服务实现类
 *
 * @author ay
...
public class ZyFhcsGrClassServiceImpl extends ServiceImpl<ZyFhcsGrClassMapper, ZyFhcsGrClass> implements ZyFhcsGrClassService {
     ...
     */
    @Override
    public IPage<ZyFhcsGrClass> getPage(PageParam<ZyFhcsGrClass> page, ZyFhcsGrClass param) {
        return zyFhcsGrClassMapper.getPage(page, param);
    }
