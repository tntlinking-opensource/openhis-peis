...
public class OccupationDiseastController extends BaseController {
     ...
     * @param occupationDiseast 查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询JC职业病名称")
    public R<IPage<OccupationDiseast>> getPage(PageParamSimple pageParamSimple, OccupationDiseast occupationDiseast) {
        PageParam<OccupationDiseast> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.occupationDiseastService.getPage(page, occupationDiseast));
    }
    ...
    public R insert(@RequestBody OccupationDiseast occupationDiseast) {
        return R.toResult(this.occupationDiseastService.save(occupationDiseast));
    }
    ...
    public R update(@RequestBody OccupationDiseast occupationDiseast) {
        return R.toResult(this.occupationDiseastService.updateById(occupationDiseast));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.occupationDiseastService.removeByIds(ids));
    }
}
