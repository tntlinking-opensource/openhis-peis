...
public class OccupationDrugController extends BaseController {
     ...
     * @param occupationDrug  查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询JC职业病/禁忌症")
    public R<IPage<OccupationDrug>> getPage(PageParamSimple pageParamSimple, OccupationDrug occupationDrug) {
        PageParam<OccupationDrug> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.occupationDrugService.getPage(page, occupationDrug));
    }
    ...
    @ApiOperationSupport(ignoreParameters = {"occupationDrug.id"})
    public R insert(@RequestBody OccupationDrug occupationDrug) {
        return R.toResult(this.occupationDrugService.save(occupationDrug));
    }
    ...
    public R update(@RequestBody OccupationDrug occupationDrug) {
        return R.toResult(this.occupationDrugService.updateById(occupationDrug));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.occupationDrugService.removeByIds(ids));
    }
}
