...
public class BasexamltemtypeController extends BaseController {
     ...
     * @param basexamltemtype 查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询JC检查项目类型表")
    public R<IPage<Basexamltemtype>> getPage(PageParamSimple pageParamSimple, Basexamltemtype basexamltemtype) {
        PageParam<Basexamltemtype> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.basexamltemtypeService.getPage(page, basexamltemtype));
    }
    ...
    public R insert(@RequestBody Basexamltemtype basexamltemtype) {
        return R.toResult(this.basexamltemtypeService.save(basexamltemtype));
    }
    ...
    public R update(@RequestBody Basexamltemtype basexamltemtype) {
        return R.toResult(this.basexamltemtypeService.updateById(basexamltemtype));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.basexamltemtypeService.removeByIds(ids));
    }
}
