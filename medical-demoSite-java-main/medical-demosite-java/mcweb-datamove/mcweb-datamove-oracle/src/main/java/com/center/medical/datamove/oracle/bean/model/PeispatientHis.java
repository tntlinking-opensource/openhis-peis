...
/**
 * QT体检者表(PeispatientHis)表实体类
 *
 * @author ay
 * @since 2023-07-18 09:23:20
 */
@Data
@TableName("PEISPATIENT_HIS")
@ApiModel(value = "PeispatientHis", description = "QT体检者表实体类")
public class PeispatientHis extends Model<PeispatientHis> implements Serializable {
    private static final long serialVersionUID = -96399081804932812L;
