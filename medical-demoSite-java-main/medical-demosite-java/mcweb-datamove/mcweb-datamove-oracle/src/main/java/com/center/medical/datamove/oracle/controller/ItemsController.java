...
public class ItemsController extends BaseController {
    ...
    public R<IPage<Items>> getPage(PageParamSimple pageParamSimple, Items items) {
        PageParam<Items> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.itemsService.getPage(page, items));
    }
    ...
    public R insert(@RequestBody Items items) {
        return R.toResult(this.itemsService.save(items));
    }
    ...
    public R update(@RequestBody Items items) {
        return R.toResult(this.itemsService.updateById(items));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.itemsService.removeByIds(ids));
    }
}
