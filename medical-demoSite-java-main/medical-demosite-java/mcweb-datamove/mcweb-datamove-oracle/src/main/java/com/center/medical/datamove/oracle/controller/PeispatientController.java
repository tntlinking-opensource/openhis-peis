...
@Api(tags = "")
@RequestMapping("peispatient")
public class PeispatientController extends BaseController {
    /**
     * 服务对象
     */
     ...
     * @param peispatient     查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R<IPage<Peispatient>> getPage(PageParamSimple pageParamSimple, Peispatient peispatient) {
        PageParam<Peispatient> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.peispatientService.getPage(page, peispatient));
    }
    ...
    public R<Peispatient> selectOne(@PathVariable String id) {
        return R.ok(this.peispatientService.getInfoById(id));
    }
    ...
    public R insert(@RequestBody Peispatient peispatient) {
        return R.toResult(this.peispatientService.save(peispatient));
    }
    ...
    public R update(@RequestBody Peispatient peispatient) {
        return R.toResult(this.peispatientService.updateById(peispatient));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.peispatientService.removeByIds(ids));
    }
}
