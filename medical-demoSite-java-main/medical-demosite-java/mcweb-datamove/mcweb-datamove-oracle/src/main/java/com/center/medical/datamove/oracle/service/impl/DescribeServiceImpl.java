...
import com.center.medical.datamove.oracle.dao.DescribeMapper;
...
public class DescribeServiceImpl extends ServiceImpl<DescribeMapper, Describe> implements DescribeService {
     ...
     */
    @Override
    public IPage<Describe> getPage(PageParam<Describe> page, Describe param) {
        return describeMapper.getPage(page, param);
    }
