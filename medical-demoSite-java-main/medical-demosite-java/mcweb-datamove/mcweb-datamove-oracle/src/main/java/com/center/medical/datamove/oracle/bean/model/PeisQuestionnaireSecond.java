...
/**
 * 健康体检问卷(PeisQuestionnaireSecond)表实体类
 *
 * @author ay
 * @since 2023-07-18 09:23:00
 */
@Data
@TableName("PEIS_QUESTIONNAIRE_SECOND")
...
public class PeisQuestionnaireSecond extends Model<PeisQuestionnaireSecond> implements Serializable {
    private static final long serialVersionUID = 252267297040779230L;
    ...
    @ApiModelProperty(value = "${column.comment}")
    private String smoke3;

    @ApiModelProperty(value = "${column.comment}")
    private String smoke4;
