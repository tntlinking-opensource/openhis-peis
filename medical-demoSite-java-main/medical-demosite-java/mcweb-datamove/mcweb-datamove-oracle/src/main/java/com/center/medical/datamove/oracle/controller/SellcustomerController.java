...
public class SellcustomerController extends BaseController {
     ...
     * @param sellcustomer    查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询我的客户表")
    public R<IPage<Sellcustomer>> getPage(PageParamSimple pageParamSimple, Sellcustomer sellcustomer) {
        PageParam<Sellcustomer> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.sellcustomerService.getPage(page, sellcustomer));
    }
    ...
    public R<Sellcustomer> selectOne(@PathVariable String id) {
        return R.ok(this.sellcustomerService.getInfoById(id));
    }
    ...
    public R insert(@RequestBody Sellcustomer sellcustomer) {
        return R.toResult(this.sellcustomerService.save(sellcustomer));
    }
    ...
    public R update(@RequestBody Sellcustomer sellcustomer) {
        return R.toResult(this.sellcustomerService.updateById(sellcustomer));
    }
    ...
    public R delete(@PathVariable List<String> ids) {
        return R.toResult(this.sellcustomerService.removeByIds(ids));
    }
}
