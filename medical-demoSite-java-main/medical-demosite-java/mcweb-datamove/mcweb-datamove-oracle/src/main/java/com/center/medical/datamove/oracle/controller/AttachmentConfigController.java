...
public class AttachmentConfigController extends BaseController {
     ...
     * @param attachmentConfig 查询条件
     * @return 所有数据
     */
    @GetMapping("/page")
    //@PreAuthorize("@ss.hasPermi('::list')")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R<IPage<AttachmentConfig>> getPage(PageParamSimple pageParamSimple, AttachmentConfig attachmentConfig) {
        PageParam<AttachmentConfig> page = mapperFacade.map(pageParamSimple, PageParam.class);
        return R.ok(this.attachmentConfigService.getPage(page, attachmentConfig));
    }
    ...
    @ApiOperationSupport(ignoreParameters = {"attachmentConfig.id"})
    public R insert(@RequestBody AttachmentConfig attachmentConfig) {
        return R.toResult(this.attachmentConfigService.save(attachmentConfig));
    }
    ...
    public R update(@RequestBody AttachmentConfig attachmentConfig) {
        return R.toResult(this.attachmentConfigService.updateById(attachmentConfig));
    }
