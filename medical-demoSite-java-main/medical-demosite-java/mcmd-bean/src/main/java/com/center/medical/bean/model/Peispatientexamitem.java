...
/**
 * LIS结果(LisPacs数据)(Peispatientexamitem)表实体类
 *
 * @author 路飞船长
...
@ApiModel(value = "Peispatientexamitem", description = "LIS结果(LisPacs数据)实体类")
public class Peispatientexamitem extends Model<Peispatientexamitem> implements Serializable {
    private static final long serialVersionUID = 610803969569824309L;
    ...
    private Double fLabrcvdfromlis;
