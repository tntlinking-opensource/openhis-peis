...
public class Peispatientfeeitem extends Model<Peispatientfeeitem> implements Serializable {
    private static final long serialVersionUID = 509527704253090351L;
    ...
    @ApiModelProperty(value = "据检状态  1据检   0未据检")
    ...
    @ApiModelProperty(value = "创建时间(老系统的创建时间，只有导入的才有)")
    private Date createDate;
