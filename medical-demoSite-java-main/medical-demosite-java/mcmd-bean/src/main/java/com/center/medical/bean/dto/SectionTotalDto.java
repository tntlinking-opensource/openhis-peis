 ...
 */
@Data
public class SectionTotalDto implements Serializable {
    private static final long serialVersionUID = -605159377967273047L;

    /**
     * 总检类型
     */
    @ApiModelProperty(value = "体检类型：0.健康 1.职业")
