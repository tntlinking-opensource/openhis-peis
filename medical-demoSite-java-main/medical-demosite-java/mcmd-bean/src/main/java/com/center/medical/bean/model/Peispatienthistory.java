...
/**
 * 体检者（history）表(Peispatienthistory)表实体类
 *
 * @author 路飞船长
...
@ApiModel(value = "Peispatienthistory", description = "体检者（history）表实体类")
public class Peispatienthistory extends Model<Peispatienthistory> implements Serializable {
    private static final long serialVersionUID = 514727329793931235L;
