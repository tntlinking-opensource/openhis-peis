...
public class WsDepartment extends Model<WsDepartment> implements Serializable {
    private static final long serialVersionUID = -11401733291795122L;
    ...
    public WsDepartment(String name, String description, String parent,
                          String dpcode, String dplevel, Integer xh, String customerId,
                          Integer isDelete) {
        super();
        this.name = name;
