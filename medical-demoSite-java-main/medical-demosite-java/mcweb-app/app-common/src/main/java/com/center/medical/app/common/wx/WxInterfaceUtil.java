...
package com.center.medical.app.common.wx;

import cn.hutool.http.HttpUtil;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.TypeReference;
import com.center.medical.app.common.exception.AppBindException;
import com.center.medical.app.common.response.WxLiveProdResponse;
import com.center.medical.app.common.response.WxServerResponse;
import com.center.medical.app.common.util.Json;
import com.center.medical.app.common.util.PageParam;
import com.center.medical.app.common.wx.bean.*;
import com.center.medical.app.common.wx.bean.resp.GoodsInfoRespParam;
import com.center.medical.app.common.wx.bean.resp.GoodsListRespParam;
import com.center.medical.app.common.wx.bean.resp.RoomDetailResponse;
import com.center.medical.app.common.wx.bean.resp.RoomResponse;
...
//    }
    ...
    public GoodsInfoRespParam prodAddVerify(GoodsInfoReqParam goodsInfo) {
        ...
        if (!Objects.equals(goodsInfoRespParam.getErrcode(), 0)) {
            // 提交审核失败
            throw new AppBindException("提交审核失败");
        }
...
//    }
    ...
    public GoodsListRespParam prodList(GoodsListReqParam goodsInfo) {
        ...
        if (!Objects.equals(goodsRespInfo.getErrcode(), 0)) {
            // 获取商品列表失败
            throw new AppBindException("yami.get.goods");
        }
        return goodsRespInfo;
    }
    ...
    private <T> T prodSignAndSend(WxInterfaceInfo wxInterfaceInfo, Map<String, Object> requestParam, TypeReference<T> typeReference) {
        ...
        if (StringUtils.contains(body, ERR_MSG)) {
            String message = "第三方请求失败";
            throw new AppBindException(message + body);
        }
    ...
    private <T> WxLiveProdResponse<T> liveProdSignAndSend(WxInterfaceInfo wxInterfaceInfo, Map<String, Object> requestParam, TypeReference<WxLiveProdResponse<T>> typeReference) {
        ...
        try {
            ...
            // 远程微信连接异常！
            throw new AppBindException("远程微信连接异常！");
        }
        log.info(body);
        return JSONObject.parseObject(body, typeReference);
    }
