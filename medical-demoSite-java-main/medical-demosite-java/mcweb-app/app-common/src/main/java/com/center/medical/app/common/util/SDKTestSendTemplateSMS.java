...
import com.center.medical.app.common.constants.SmsConstants;
...
public class SDKTestSendTemplateSMS {
    ...
    @SuppressWarnings("unchecked")
    public static final String sendMsg(String tels, String idTemplate, String[] params, String appId) {
        HashMap<String, Object> result = null;
        ...
        //*参数顺序：第一个参数是ACOUNT SID，第二个参数是AUTH TOKEN。                   *
        //*******************************************************************************
        restAPI.setAccount(SmsConstants.ACCOUNT_SID, SmsConstants.AUTH_TOKEN);
     ...
     * 家庭卡充值消费发送短信
     */
    public static final String sendFamilyCardMsg(String tels
            , String[] params, boolean isCharge) {
        ...
        return sendMsg(tels, idTemplate, params, appId);
    }
}
