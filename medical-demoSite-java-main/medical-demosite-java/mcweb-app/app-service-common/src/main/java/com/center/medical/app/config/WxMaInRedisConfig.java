...
public class WxMaInRedisConfig extends WxMaDefaultConfigImpl {
    ...
    public WxMaInRedisConfig(WxMiniApp wxMiniApp, RedissonClient redissonClient) {
    ...
    public String getAccessToken() {
        String tokenString = RedisUtil.get(accessTokenKey);
        log.info("RedisUtil.get(accessTokenKey)：" + tokenString);
        return tokenString;
    }
