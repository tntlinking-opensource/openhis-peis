...
import com.center.medical.system.dao.SysOperLogMapper;
...
public class SysOperLogServiceImpl implements ISysOperLogService {
     ...
     */
    @Override
    public List<SysOperLog> getLeOperTime(DateTime operTime) {
        return operLogMapper.getLeOperTime(operTime);
    }
}
