...
/**
 * kingdeedepartment(KdDepartment)表实体类
 *
 * @author 路飞船长
...
@ApiModel(value = "KdDepartment", description = "kingdeedepartment实体类")
public class KdDepartment extends Model<KdDepartment> implements Serializable {
    private static final long serialVersionUID = 910439007435669311L;
