...
import com.center.medical.common.core.domain.entity.SysUserRole;
...
import com.center.medical.system.service.ISysRoleService;
...
public class SysRoleController extends BaseController {
    ...
    @GetMapping("/list")
    @ApiOperation(value = "角色列表", notes = "获取用户角色列表")
    ...
    @PostMapping("/export")
    @ApiOperation(value = "导出列表", notes = "导出用户角色列表")
    ...
    @ApiOperation(value = "获取角色信息", notes = "根据角色编号获取详细信息")
