 ...
 */
public interface SMSFollowUpMapper extends BaseMapper<Peispatient> {
    ...
    * @return 分页数据
    */
    IPage<SMSFollowUpVo> getList(PageParam<SMSFollowUpVo> page, @Param("param") SMSFollowUpParam param);
