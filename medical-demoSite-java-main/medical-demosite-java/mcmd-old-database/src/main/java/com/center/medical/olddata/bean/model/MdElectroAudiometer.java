...
public class MdElectroAudiometer extends Model<MdElectroAudiometer> implements Serializable {
    private static final long serialVersionUID = -48070508786507643L;
    ...
    private String boneLeft6000;


    @ApiModelProperty(value = "骨导右耳6000Hz")
    private String boneRight6000;


    @ApiModelProperty(value = "骨导左耳8000Hz")
    private String boneLeft8000;


    @ApiModelProperty(value = "骨导右耳8000Hz")
    private String boneRight8000;
