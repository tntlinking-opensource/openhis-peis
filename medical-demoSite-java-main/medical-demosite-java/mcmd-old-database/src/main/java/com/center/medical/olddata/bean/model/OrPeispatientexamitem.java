...
/**
 * LIS结果(Peispatientexamitem)表实体类
 *
 * @author ay
 * @since 2024-06-05 15:00:11
 */
@Data
@TableName("PEISPATIENTEXAMITEM")
@ApiModel(value = "Peispatientexamitem", description = "LIS结果实体类")
public class OrPeispatientexamitem extends Model<OrPeispatientexamitem> implements Serializable {
    private static final long serialVersionUID = -78748152644646339L;
    ...
    private Integer idPatientfeeitem;
    ...
    private Integer idExamitemvalue;
    ...
    @ApiModelProperty(value = "COLUMN_57")
    private Integer type;


    @ApiModelProperty(value = "COLUMN_58")
