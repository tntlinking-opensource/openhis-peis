 ...
 */
public interface MdVationAndFzxMapper extends BaseMapper<MdVationAndFzx> {
     ...
     * @return 分页数据
     */
    IPage<MdVationAndFzx> getPage(PageParam<MdVationAndFzx> page, @Param("param") MdVationAndFzx param);
     ...
     * @return 详情信息
     */
    MdVationAndFzx getInfoById(@Param("id") String id);
